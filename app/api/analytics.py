...
async def get_performance_analytics(
    ...
    analytics = await AnalyticsService.get_performance_analytics(
...
async def get_accessibility_analytics(
    ...
    analytics = await AnalyticsService.get_accessibility_analytics(db, str(current_user.id))
...
async def track_accessibility_usage(
    ...
    await AnalyticsService.update_accessibility_usage(db, str(current_user.id), feature)
